                ...
                <div class="col-md-12">
                    <div class="content-panel">
                        ...
                        <div class="col-sm-6"><button class="btn btn-primary btn-xs pull-right"><i class="fa fa-plus"></i> Nuevo</button></div>-->
                            <h4><i class="fa fa-angle-right"></i> Laboratorios<a class="btn btn-primary pull-right" data-toggle='modal' href="#ventana"><i class="fa fa-plus"></i> Nuevo</a></h4>
                            <hr>
                            <thead>
                            <tr>
                                <th><i class="fa fa-bullhorn"></i> Nro</th>
                                <th class="hidden-phone"><i class="fa fa-question-circle"></i> Especialidad</th>
                                <th class="hidden-phone"><i class="fa fa-question-circle"></i> Laboratorio</th>
                            ...
                            if(!empty($laboratorios)){
                                foreach($laboratorios as $fila):
                                    ?>
                                    <tr>
                                        <td><?=$fila->LAB_ID?></td>
                                        <td><?=$fila->ESP_NOMBRE?></td>
                                        <td><?=$fila->LAB_NOMBRE?></td>
                                        <td><?=$fila->LAB_DESC?></td>
                                        <td>
                                            <button class="btn btn-primary" onClick="modificar('laboratorios','<?=$fila->LAB_ID?>')"><i class="fa fa-pencil"></i></button>
                                            <button class="btn btn-danger eliminar" id="<?=$fila->LAB_ID?>" name="laboratorios" title="<?=$fila->LAB_NOMBRE?>"><i class="fa fa-trash-o "></i></button>
                                        </td>
                                    </tr>
                                <?php endforeach; } ?>
                            </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title"><i class="fa fa-flask"></i> Registro de Laboratorio</h1>
                </div>
                <div class="modal-body">
                    <form id="form" role="form"  action="<?=base_url()?>" method="POST">
                        ...
                        <div class="form-group row">
                            <label for="nombre" class="col-sm-3">Laboratorio:</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="con" id="con" value="laboratorios">
