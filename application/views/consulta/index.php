          ...
          <section class="wrapper">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel"><!-- contenido inicio-->
                          ...
                          <table id="tabla_estado" class="table table-striped table-bordered table-advance table-hover" cellspacing="0" width="100%">
                              ...
                              <tr <?php if($consul->CON_ESTADO == 0): echo '<tr class="warning"';elseif($consul->CON_ESTADO == 1): echo '<tr class="info"';
                                elseif($consul->CON_ESTADO == 2): echo '<tr class="danger"';?><?php endif; ?>>
                                  ...
                                  <td class="text-center estado-producto" data-link="<?=base_url()?>consultas/cambiar" data-id='<?=$consul->CON_ID?>' data-estado='<?=$consul->ESTADO?>'>
                                  <?php 
                                    if($consul->CON_ESTADO == 0): echo '<button type="button" class="btn btn-warning btn-xs disabled">no atendido</button>';
                                    elseif($consul->CON_ESTADO == 1): echo '<button type="button" class="btn btn-primary btn-xs disabled">atendido</button>';
                                    elseif($consul->CON_ESTADO == 2): echo '<button type="button" class="btn btn-danger btn-xs disabled">cancelado</button>';
                                  ?>
                                  <?php endif; ?>
                                  </td>
                                  <td>
                                      <a href="<?=base_url()?>consultas/nueva/<?=$consul->CON_ID.'/'.$consul->PAC_ID.'/'.$consul->DES_ID?>" class="btn btn-success"><i class="fa fa-pencil"></i> Consulta</a>
                                      <button class="btn btn-danger estado" id="<?=$consul->CON_ID?>" name="consultas" title="<?=$consul->PAC_NOMBRE . ' ' . $consul->PAC_PATERNO . ' ' . $consul->PAC_MATERNO?>">Cancelar</button>
                                      <button class="btn btn-danger eliminar" id="<?=$consul->CON_ID?>" name="consultas" title="<?=$consul->PAC_NOMBRE . ' ' . $consul->PAC_PATERNO . ' ' . $consul->PAC_MATERNO?>"><i class="fa fa-trash-o "></i> Borrar</button>
                                  </td>
                              </tr>
                              <?php endforeach; ?>
