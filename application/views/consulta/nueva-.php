...
<table class="table table-responsive">
    ...
    <tbody>
    <?php foreach ($enlaceS as $rowss) : ?>                                            
        <tr>
            <td><input type="text" name="pulso" class="form-control" value="<?=$rowss->SIG_PULSO?>" required/></td>
            <td><input type="text" name="peso" class="form-control" value="<?=$rowss->SIG_PESO?>" required/></td>
            <td><input type="text" name="talla" class="form-control" value="<?=$rowss->SIG_TALLA?>" required/></td>
            <td><input type="text" name="ps" class="form-control" value="<?=$rowss->SIG_PRE_SAN?>" required/></td>
            <td><input type="text" name="fc" class="form-control" value="<?=$rowss->SIG_FRE_CAR?>" required/></td>
        </tr>
    <?php endforeach; ?>    
    </tbody>
</table>
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-12">
                                                                ...
                                                                <div class="col-xs-6">
                                                                    <table class="table table-responsive tab">
                                                                        <thead>
                                                                            <tr>
                                                                                <th></th>
                                                                                <th>Nombre Patologia</th>
                                                                        ...
                                                                        <tbody>
                                                                            <?php foreach ($enlaceD as $rows) : ?>
                                                                            <tr>
                                                                                <td><input type="checkbox" value="<?=$rows->PAT_ID?>"disabled
                                                                                <?php if($rows->PAT_ID == TRUE): echo 'checked';?>
                                                                                <?php endif; ?>
                                                                                ></td>
                                                                                <td><?=$rows->PAT_NOMBRE?></td>
                                                                            </tr>
                                                                            <?php endforeach; ?>
