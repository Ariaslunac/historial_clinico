          ...
          <section class="wrapper">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel"><!-- contenido inicio-->
                              <h4><i class="fa fa-angle-right"></i> Reporte de consultas<a class="btn btn-info pull-right" href="#" id="pdf"><i class="fa fa-print"></i> Imprimir</a></h4><br>
		<form name="formr" id="formr" action="<?=base_url();?>reportes/consultas" method="POST">
		...
		<div class="row form-group">
			...
			<?php $i++; endforeach; } ?>
                              ...
                              <tr>
                                  ...
                                  <th class="hidden-phone">Costo</th>
                                  <!--<th class="hidden-phone">Imprimir</th>-->
                              </tr>
                              </thead>
                              <tbody>
                              <?php $total=0; foreach ($listado as $consul) : $total+=$consul->ESP_COSTO; ?>
                              <tr>
...
//$(document).ready(function(){
	...
	$("#pdf").click(function(){
		...
		var hor = $("#horario").val();
		window.open("<?=base_url()?>reportes/pdf_consultas/"+fei+"/"+fef+"/"+cod+"/"+esp+"/"+per+"/"+con+"/"+hor,"_blank");
	});
//});
</script>
