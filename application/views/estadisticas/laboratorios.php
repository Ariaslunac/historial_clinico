...
<html lang="en">
  ...
  <section id="container">
      ...
      <section id="main-content">
          <section class="wrapper">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel"><!-- contenido inicio-->
                              ...
                              <h4><i class="fa fa-angle-right"></i> Estadistica de Laboratorios<!--<a class="btn btn-info pull-right" href="#" id="pdf"><i class="fa fa-file-pdf-o"></i> Imprimir</a>--></h4><br>
		<form name="formr" id="formr" action="<?=base_url();?>estadisticas/laboratorios" method="POST">
        ...
        <i style="background-color:<?=color($c,1);?>">&nbsp;&nbsp;&nbsp;</i> <strong></strong> <?=$fila->LAB_NOMBRE?><br>
        <?php $c++;endforeach; ?>
...
var pieData = [
				...
				?>
				{
					value: <?php echo $this->estadistica->consultas_l($anio,$mes,0,$esp,$per,$con,$hor,$fila->LAB_ID); ?>,
					color:"<?=color($c,1); ?>",
					highlight: "<?=color($c,2); ?>",
					label: "<?php echo $fila->LAB_NOMBRE; ?>"
				}
				<?php $c++; endforeach; ?>
				/*,
				{
